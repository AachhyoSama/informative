...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">New Popup Notice <a href="{{ route('popupnotice.index') }}" class="btn btn-primary">Popup Notices</a></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('popupnotice.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method("POST")
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <img id="cover_image_output" style="height: 250px; width:450px;" src="{{ Storage::disk('uploads')->url('noimage.jpg') }}">
                                            </div>
