    ...
    <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Update Member PDF <a href="{{ route('memberpdf.index') }}" class="btn btn-primary">View PDFs</a></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('memberpdf.update', $memberPDF->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method("PUT")
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <p class="text-danger">
                                                        Do not select new pdf if you want previous one.
                                                    </p>
                                                    <p class="text-danger">
                                            ...
                                            <div class="col-md-6 mt-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $memberPDF->name['en'] }}"
                                                        class="form-control" name="name[en]" placeholder="Name..">
                                                    <p class="text-danger">
                                                        {{ $errors->first('name') }}
                                                    </p>
                                                </div>
                                            ...
                                            <div class="col-md-6 mt-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $memberPDF->name['np'] }}"
                                                        class="form-control" name="name[np]" placeholder="Name..">
                                                    <p class="text-danger">
                                                        {{ $errors->first('name') }}
                                                    </p>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="member_category" class="form-control member">
                                                        ...
                                                        @foreach ($memberCategories as $memberCategory)
                                                            <option value="{{ $memberCategory->id }}" {{ $memberCategory->id == $memberPDF->member_id ? 'selected' : '' }}>{{ $memberCategory->category_name['en'] }}</option>
                                                        @endforeach
                                                    </select>
                                                    <p class="text-danger">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="member_subcategory" class="form-control" id="member_subcategory">
                                                        ...
                                                        @foreach ($member_subcategories as $subcategory)
                                                            <option value="{{ $subcategory->id }}" {{ $subcategory->id == $memberPDF->member_subcategory_id ? 'selected' : '' }}>{{ $subcategory->sub_category_name['en'] }}</option>
                                                        @endforeach
                                                    </select>
                                                    <p class="text-danger">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="commitee_category" class="form-control committee">
                                                        ...
                                                        @foreach ($commiteeCategories as $commiteeCategory)
                                                            <option value="{{ $commiteeCategory->id }}" {{ $commiteeCategory->id == $memberPDF->committee_id ? 'selected' : '' }}>{{ $commiteeCategory->category_name['en'] }}</option>
                                                        @endforeach
                                                    </select>
                                                    <p class="text-danger">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="committee_subcategory" class="form-control" id="committee_subcategory">
                                                        ...
                                                        @foreach ($committee_subcategories as $committee_sub)
                                                            <option value="{{ $committee_sub->id }}" {{ $committee_sub->id == $memberPDF->committee_subcategory_id ? 'selected' : '' }}>{{ $committee_sub->sub_category_name['en'] }}</option>
                                                        @endforeach
                                                    </select>
                                                    <p class="text-danger">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <label class="switch pt-0">
                                                        <input type="checkbox" name="active" value="1"{{ $memberPDF->is_active == 1 ? 'checked' : '' }}>
