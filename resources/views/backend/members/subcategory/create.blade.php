    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">New Subcategory <a href="{{ route('subCategory.index') }}"
                                class="btn btn-primary">View Subcategories</a></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="sub_category_name[en]"
                                                    id="sub_category_name" placeholder="Subcategory Name.." required>
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="sub_category_name[np]"
                                                    id="sub_category_name" placeholder="Subcategory Name.." required>
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <img id="current_og" style="height: 100px;"
